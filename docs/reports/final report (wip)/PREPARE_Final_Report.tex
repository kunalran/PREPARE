...
\sloppy
\title{Prediction of Prices in Agriculture (PREPARE)}
\author{
\IEEEauthorblockN{Varun SG, Kunal Ranjan, Aryan Gosain, Rishit Anand}
...
\begin{IEEEkeywords}
agricultural price forecasting, graph neural networks, GAT-GRU, mandi networks, spatiotemporal modeling
\end{IEEEkeywords}

\textbf{Institution:} Plaksha University
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/data_inventory.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/state_distribution.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/imputation_comparison.png}
...
\begin{itemize}
\item \textbf{DOW Ratio} dominated at the >=50\% threshold and remained competitive at >=75\%, effectively handling structural weekend missingness
\item \textbf{Rolling Mean} won at >=75\% for crops like potato and wheat where dense surrounding data was available
...
\item \textbf{Metrics:} R-squared (primary), WAPE (Weighted Absolute Percentage Error), RMSE, MAE
...
\caption{Baseline R-squared Comparison: 1-Day vs 15-Day}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/focused_1d_models.png}
\caption{1-Day R-squared: Focused Tuned Models}
\end{figure}
...
\begin{itemize}
\item \texttt{delta\_current}: predict deviation from current price
\item \texttt{delta\_roll7}: predict deviation from 7-day rolling mean
\item \texttt{delta\_roll28}: predict deviation from 28-day rolling mean
\end{itemize}

\textbf{GAT-GRU Ablations performed:}
...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
Crop & 15-Day Baseline & Best Rolling Baseline & Best Non-Graph & \textbf{Best Graph (GAT-GRU)} \\
\hline
Onion & 0.6508 & 0.7788 & 0.7075 & \textbf{0.8134} \\
\hline
Potato & 0.8937 & 0.9336 & 0.9365 & \textbf{0.9380} \\
\hline
Tomato & 0.2588 & 0.3791 & 0.3675 & \textbf{0.3914} \\
\hline
Wheat & 0.6209 & 0.6663 & 0.6764 & \textbf{0.7026} \\
\hline
\end{tabularx}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/model_family_15d.png}
\caption{15-Day R-squared Across Model Families}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/best_model_r2.png}
\caption{Best Model R-squared vs Previous-Day Baseline}
\end{figure}

\subsection{R-squared Decay Over Forecast Horizon}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/horizon_decay.png}
\caption{R-squared Decay Over Forecast Horizon}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/graph_vs_nongraph.png}
...
\begin{itemize}
\item Graph models clearly benefit onion and wheat (gains of roughly 0.03-0.04 R-squared)
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/wape_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/radius_sweep.png}
...
\item \textbf{Simple tabular models at 15 days:} Collapsed for onion (negative R-squared) and was weak for tomato, showing that tabular models without spatial awareness are not sufficient for long-horizon forecasting.
...
[1] Bhardwaj, M. R. (2023). \textit{Novel Algorithms for Improving Agricultural Planning and Operations using Artificial Intelligence and Game Theory.} Doctoral dissertation, Indian Institute of Science, Bangalore.

[2] Yu, B., Yin, H., and Zhu, Z. (2018). Spatio-temporal Graph Convolutional Networks: A Deep Learning Framework for Traffic Forecasting. In \textit{Proceedings of IJCAI 2018}.

[3] Wu, Z., Pan, S., Long, G., Jiang, J., and Zhang, C. (2019). Graph WaveNet for Deep Spatial-Temporal Graph Modeling. In \textit{Proceedings of IJCAI 2019}.

[4] Li, Y., Yu, R., Shahabi, C., and Liu, Y. (2018). Diffusion Convolutional Recurrent Neural Network: Data-Driven Traffic Forecasting. In \textit{Proceedings of ICLR 2018}.

[5] Velickovic, P., Cucurull, G., Casanova, A., Romero, A., Lio, P., and Bengio, Y. (2018). Graph Attention Networks. In \textit{Proceedings of ICLR 2018}.

[6] Chen, T. and Guestrin, C. (2016). XGBoost: A Scalable Tree Boosting System. In \textit{Proceedings of KDD 2016}.

[7] Ke, G., Meng, Q., Finley, T., et al. (2017). LightGBM: A Highly Efficient Gradient Boosting Decision Tree. In \textit{Advances in Neural Information Processing Systems (NeurIPS) 2017}.

[8] Meena, M., et al. (2025). Self-Adaptive Graph Mixture of Models. \textit{arXiv preprint arXiv:2511.13062}.

[9] Agmarknet Portal. Government of India, Ministry of Agriculture and Farmers' Welfare. \url{https://agmarknet.gov.in/}
